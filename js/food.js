const FOODS = [
    ...
    { name: '성산 해녀의 집', region: '제주', category: '해산물', menu: '전복죽, 해산물 물회, 성게국', desc: '성산일출봉 인근에서 해녀가 직접 잡아 올린 신선한 해산물을 맛볼 수 있습니다. 성게알이 듬뿍 들어간 성게국과 전복죽이 대표 메뉴입니다.', loc: '제주 서귀포시 성산읍 일대', emoji: '🐙' },
